...
start_str= [[
it's been a year and you 

made it. yes there's still 

much change to come. hang 

in there, you are loved.

leave this past year 

behind. make your next 

moment a step towards a 
...
function _draw()
	...
	if (start_t > 0) then
		...
		-- print(start_str,12,12+1,3)
		print(start_str,12,12,16)
		rectfill(0,119,127,127,1)
		print("tap 🅾️ circle to start",20,121,15)
		spr(78 + rnd(2), 12, 108)
		print("🅾️ jump (fly)",25,110,1)
		spr(76, 67, 107)		
		print("❎ snow",70,110)
		if (btnp(🅾️)) then
			start_t = 0
...

...

